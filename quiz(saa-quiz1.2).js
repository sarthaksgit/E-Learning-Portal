...
let questions = [
    ...
    answer: "Create a Lustre file system through Amazon FSx.",
    options: [
    ...
    answer: "Create a new parameter group, attach it to the DB instance and change the setting.",
    options: [
    ...
    answer: "Configure Elastic Fabric Adapter (EFA) in the instance", 
    options: [
