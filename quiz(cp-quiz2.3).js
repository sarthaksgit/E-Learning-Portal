...
let questions = [
    ...
    answer: "Deploy Amazon EC2 instance with Auto-scaling",
    options: [
    ...
    {
    numb: 3,
    question: " Which of the following activities are within the scope of AWS Support?",
    answer: "Troubleshooting API issues",
    options: [
      "Code Development",
